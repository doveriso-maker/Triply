...
המיתוג עודכן ב־22.09.2026 על בסיס האתר הקיים.

- עברית: `/`
- ערבית: `/ar.html`
- רוסית: `/ru.html`
- קובצי המותג המאושרים: `assets/navigam/`
- בדיקות ומגבלות פריסה: `NAVIGAM_REBRAND_QA_HE.md`

גרסת בסיס האפליקציה V4 נשמרת בנפרד במאגר האפליקציה. מזהי TRIPLY פנימיים וכתובות שירות קיימות אינם שמות המותג הגלויים, ונשמרו לתאימות.
